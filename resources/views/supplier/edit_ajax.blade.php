            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $supplier->supplier_kode }}" type="text" name="supplier_kode" id="nama"
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $supplier->supplier_telepon }}" type="tel" name="supplier_telepon" id="supplier_telepon"
                            class="form-control" required>
